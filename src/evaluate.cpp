...
Value Eval::evaluate(const Eval::NNUE::Networks& networks, const Position& pos, int optimism) {
    ...
    const auto adjustEval = [&](int optDiv, int nnueDiv, int nnueConstant, int optConstant,
        ...
        v = (nnue * (nnueConstant + simpleEval) + optimism * (optConstant + simpleEval)) / evalDiv;
    ...
    if (!smallNet)
        adjustEval(513, 19437, 60288, 10752, 66304, 178, 204);
    else if (psqtOnly)
        adjustEval(517, 19714, 59584, 11392, 65216, 224, 238);
    else
        adjustEval(499, 19676, 59264, 10880, 68288, 208, 211);
